...
class PersonTest {
    ...
    public void testEquals() {
        // to create new copy of object, need to start with it name, fix "Person person2 = new Person..."
        person2 = new Person("Alan", "Turning", 5.3f); // Name from "Turning" to "Turing"
        Assert.assertEquals(person, person2); // 2 copy of object with same values, as still 2 different objects.
        // Also there is "equals" method not used.
        // So Test could be changed to " Assertions.assertEquals(person.equals(person2), person.equals(person));"
    }
